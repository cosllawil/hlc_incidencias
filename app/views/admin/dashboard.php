  ...
  <div class="screen">
    ...
    <div class="screen">
      <div class="wrap">
        <div class="section-head2">
          <h6>Atender Incidencias</h6>
        </div>
        <a href="atender" class="app-card d-flex align-items-center justify-content-between p-3 rounded-4 shadow-sm text-decoration-none">
          <div class="d-flex align-items-center gap-3 flex-grow-1">
            ...
            <div class="app-card__text flex-grow-1">
              <span class="title d-block text-dark small">
                Aquí podrás atender las incidencias
              </span>
            </div>
          </div>
    ...
    <div class="screen">
      <div class="wrap">
        ...
        <a href="usuarios" class="app-card d-flex align-items-center justify-content-between p-3 rounded-4 shadow-sm text-decoration-none">
          <div class="d-flex align-items-center gap-3 flex-grow-1">
            <span class="d-flex align-items-center justify-content-center rounded-circle text-white" style="background-color:#00b0ff; width:42px; height:42px; font-size:1.2rem;">
    ...
    <div class="screen">
      <div class="wrap">
        <div class="section-head2">
          <h6>Opiniones a Mejorar</h6>
        </div>
        <a href="veropinion" class="app-card d-flex align-items-center justify-content-between p-3 rounded-4 shadow-sm text-decoration-none">
          <div class="d-flex align-items-center gap-3 flex-grow-1">
            <span class="d-flex align-items-center justify-content-center rounded-circle text-white" style="background-color:#00b0ff; width:42px; height:42px; font-size:1.2rem;">
