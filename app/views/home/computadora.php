...
<head>
  ...
  <title>Hospital La Caleta - Computadora</title>
  ...
  <link rel="stylesheet" href="/hlc_incidencias/assets/css/computadora.css?v=1">
</head>
...
<body>
  ...
  <div class="screen">
    ...
    <div class="section-head d-flex align-items-center justify-content-between">
      <h6 class="mb-0">Mi Computadora</h6>
      <a href="dashboard" class="btn btn-sm btn-light rounded-pill">
        <i class="bi bi-arrow-left"></i> Volver
      </a>
    </div>
    <div class="formulario">
      <form method="post" action="computadora" enctype="multipart/form-data" id="frmIncidencia">
  ...
  <script src="/hlc_incidencias/assets/js/computadora.js?v=1" defer></script>
