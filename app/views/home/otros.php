...
<head>
  ...
  <title>Hospital La Caleta - Otros</title>
  ...
  <link rel="stylesheet" href="/hlc_incidencias/assets/css/otros.css?v=1">
</head>
...
<body>
  ...
  <div class="screen">
    ...
    <div class="formulario">
      <form method="post" action="otros" enctype="multipart/form-data" id="frmIncidencia">
        ...
        <div class="position-relative mb-14">
          ...
          <select name="TipoProblema" id="TipoProblema" class="form-select select2" style="width:100%;">
            ...
            <?php foreach ($otros as $ot): ?>
              <option value="<?= htmlspecialchars($ot['nombre']) ?>">
                <?= htmlspecialchars($ot['nombre']) ?>
              </option>
            <?php endforeach; ?>
          </select>
        </div>
  ...
  <script src="/hlc_incidencias/assets/js/otros.js?v=1" defer></script>
