...
<head>
  ...
  <title>Hospital La Caleta - Impresora</title>
  ...
  <link rel="stylesheet" href="/hlc_incidencias/assets/css/impresora.css?v=1">
</head>
...
<body>
  ...
  <div class="screen">
    ...
    <div class="section-head d-flex align-items-center justify-content-between">
      <h6 class="mb-0">Mi Impresora</h6>
      <a href="dashboard" class="btn btn-sm btn-light rounded-pill">
        <i class="bi bi-arrow-left"></i> Volver
      </a>
    </div>
    <div class="formulario">
      <form method="post" action="impresora" enctype="multipart/form-data" id="frmIncidencia">
          ...
          <select name="TipoProblema" id="TipoProblema" class="form-select select2" style="width:100%;">
            ...
            <?php if (!empty($impresoras)): ?>
              <?php foreach ($impresoras as $imp): ?>
                <option value="<?= htmlspecialchars($imp['nombre']) ?>">
  ...
  <script src="/hlc_incidencias/assets/js/impresora.js?v=1" defer></script>
