...
<head>
  ...
  <title>Hospital La Caleta - Internet</title>
  ...
  <link rel="stylesheet" href="/hlc_incidencias/assets/css/internet.css?v=1">
</head>
...
<body>
  ...
  <div class="screen">
    ...
    <div class="section-head d-flex align-items-center justify-content-between">
      <h6 class="mb-0">Mi Internet</h6>
      <a href="dashboard" class="btn btn-sm btn-light rounded-pill">
        <i class="bi bi-arrow-left"></i> Volver
      </a>
    </div>
    <div class="formulario">
      <form method="post" action="internet" enctype="multipart/form-data" id="frmIncidencia">
        ...
        <div class="position-relative mb-14">
          ...
          <select name="TipoProblema" id="TipoProblema" class="form-select select2" style="width:100%;">
            ...
            <?php foreach ($internet as $it): ?>
              <option value="<?= htmlspecialchars($it['nombre']) ?>">
  ...
  <script src="/hlc_incidencias/assets/js/internet.js?v=1" defer></script>
