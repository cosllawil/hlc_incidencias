...
<head>
  ...
  <title>Hospital La Caleta - Opinión</title>
  ...
  <link rel="stylesheet" href="/hlc_incidencias/assets/css/opinion.css?v=1">
</head>
...
<body>
  ...
  <div class="screen">
    ...
    <div class="formulario">
      <form method="post" action="opinion" id="frmIncidencia">
        ...
        <button type="submit" class="btn btn-primary w-100 mb-3">
          Registrar Opinion <i class="bi-check-circle-fill fs-5"></i>
        </button>
      </form>
    </div>
  </div>
  ...
  <script src="/hlc_incidencias/assets/js/opinion.js?v=1" defer></script>
