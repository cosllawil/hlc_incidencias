...
<head>
  ...
  <title>Hospital La Caleta - Luz</title>
  ...
  <link rel="stylesheet" href="/hlc_incidencias/assets/css/luz.css?v=1">
</head>
...
<body>
  ...
  <div class="screen">
    ...
    <div class="section-head d-flex align-items-center justify-content-between">
      <h6 class="mb-0">No hay luz</h6>
      <a href="dashboard" class="btn btn-sm btn-light rounded-pill">
        <i class="bi bi-arrow-left"></i> Volver
      </a>
    </div>
    <div class="formulario">
      <form method="post" action="luz" enctype="multipart/form-data" id="frmIncidencia">
        ...
        <div class="position-relative mb-14">
          ...
          <select name="TipoProblema" id="TipoProblema" class="form-select select2" style="width:100%;">
            ...
            <?php foreach ($luz as $lz): ?>
              <option value="<?= htmlspecialchars($lz['nombre']) ?>">
                <?= htmlspecialchars($lz['nombre']) ?>
              </option>
            <?php endforeach; ?>
          </select>
        </div>
  ...
  <script src="/hlc_incidencias/assets/js/luz.js?v=1" defer></script>
