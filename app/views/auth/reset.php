...
<head>
  ...
  <link rel="stylesheet" href="/hlc_incidencias/assets/css/auth_reset.css?v=1">
</head>
...
<body>
    ...
    <div class="formulario" autocomplete="off">
      <form method="post" action="reset">
        ...
        <button type="submit" class="btn btn-primary w-100 mb-3">
          Cambiar Contraseña <i class="bi-lock-fill fs-5"></i>
        </button>
  ...
  <script src="/hlc_incidencias/assets/js/auth_reset.js?v=1" defer></script>
